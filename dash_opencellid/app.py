...
# mapbox token is no longer needed for this app
# # Load mapbox token
...
@app.callback(
    [
        ...
        Output("radio-histogram", "figure"),
        Output("range-histogram", "figure"),
        Output("created-histogram", "figure"),
    ],
    [
        Input("map-graph", "relayoutData"),
        Input("radio-histogram", "selectedData"),
        Input("range-histogram", "selectedData"),
        Input("created-histogram", "selectedData"),
    ],
)
def update_plots(
    relayout_data,
    ...
    selected_radio_counts = (
        agg_range_created_radio.sel(log10_range=range_slice, created=created_slice)
...
def build_range_histogram(selected_range_counts, selection_cleared):
    ...
    fig = {
        ...
        "layout": {
            ...
            "height": 300,
            "margin": {"l": 10, "r": 10, "t": 10, "b": 10},
            "xaxis": {"automargin": True, "title": {"text": "log<sub>10</sub>(range)"}},
            "yaxis": {
                "type": "log",
                "automargin": True,
                "title": {"text": "Count"},
    ...
    fig["data"].append(
        {
            ...
            "unselected": {
                "marker": {
                    "color": bar_unselected_color,
                    "opacity": bar_unselected_opacity,
                }
            },
            "selectedpoints": selectedpoints,
            "hoverinfo": "x+y",
...
def build_created_histogram(selected_created_counts, selection_cleared):
    ...
    fig = {
        ...
        "layout": {
            ...
            "yaxis": {"title": {"text": "Count"}, "type": "log", "automargin": True},
            "selectdirection": "h",
            "dragmode": "select",
            "hovermode": "closest",
        },
